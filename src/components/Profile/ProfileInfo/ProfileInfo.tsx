        ...
        <div>
            <section className={pStyle.profileBanner}>
                <img className={pStyle.profileBannerImg}
                     src='https://images.squarespace-cdn.com/content/v1/57dea572579fb3ea46810d43/1477314236757-Z9L4BOPJRYS6JZEO0OBA/image-asset.png?format=1000w' alt={'banner'}/>
            </section>
            <section className={pStyle.profileInfo}>
                <div className='Avatar'>
                    <img className={pStyle.avatarImg}
                         src={props.photos.large  && props.photos.small }  alt={'avatar'}/>
                </div>
